...
<div class="policy-container">
    <div class="policy">
        ...
        <br><br>
        <p>Multiversum, gevestigd te Utrecht, KvK-nummer [KvK], wordt in deze algemene voorwaarden aangeduid als verkoper.
        ...
        <br><br>
        <h1>Artikel 2: Toepasselijkheid algemene voorwaarden</h1>
        <p>Deze voorwaarden zijn van toepassing op alle offertes, aanbiedingen, overeenkomsten en leveringen van diensten of goederen door of namens verkoper.
            Afwijken van deze voorwaarden kan alleen als dat uitdrukkelijk én schriftelijk door partijen is overeengekomen.
        </p>
        <br><br>
        <h1>Artikel 3: Betaling </h1>
        <p>De volledige koopsom wordt altijd meteen in de winkel voldaan. Bij reserveringen wordt in sommige gevallen een aanbetaling verwacht. In dat geval krijgt de koper een bewijs van de reservering en de vooruitbetaling.
            ...
            <p>
                <br><br>
                <h1>Artikel 4: Aanbiedingen, offertes en prijs </h1>
                <p>Aanbiedingen zijn vrijblijvend, tenzij in het aanbod een termijn van aanvaarding is genoemd. Wordt het aanbod niet binnen die gestelde termijn aanvaard, dan vervalt het aanbod.
                ...
                <br><br>
                <h1>Artikel 5: Herroepingsrecht</h1>
                <p>De consument krijgt het recht om na ontvangst van de bestelling binnen 14 dagen de overeenkomst zonder opgave van redenen te ontbinden (herroepingsrecht). De termijn begint te lopen vanaf het moment dat de (gehele) bestelling door de consument is ontvangen.
                    ...
                    De consument kan een herroepingsformulier van verkoper gebruiken. Verkoper is gehouden dit terstond na de vraag van koper aan koper ter beschikking te stellen.
                    ...
                    Indien hij van zijn herroepingsrecht gebruik maakt, zal hij het ongebruikte en onbeschadigde product met alle geleverde toebehoren en - indien redelijkerwijze mogelijk - in de originele verzendverpakking aan verkoper retourneren,
                    conform de door de ondernemer verstrekte redelijke en duidelijke instructies.
                </p>
                <br><br>
                <h1>Artikel 6: Wijziging van de overeenkomst</h1>
                <p>Indien tijdens de uitvoering van de overeenkomst blijkt dat het voor een behoorlijke uitvoering van de opdracht noodzakelijk is om de te verrichten werkzaamheden te wijzigen of aan te vullen, passen partijen tijdig en in onderling overleg de overeenkomst dienovereenkomstig aan.
                ...
                <p>Zodra het gekochte door de koper in ontvangst is genomen, gaat het risico over van verkoper naar koper.<p>
                        ...
                        <br><br>
                        <h1>Artikel 9: Monsters en modellen</h1>
                        <p>Is aan koper een monster of model getoond of verstrekt, dan wordt het vermoed slechts als aanduiding te zijn verstrekt zonder dat de te leveren zaak daaraan behoeft te beantwoorden. Dit is anders als partijen uitdrukkelijk zijn overeengekomen dat de te leveren zaak wel daarmee zal overeenstemmen.
                        ...
                        <br><br>
                        <h1>Artikel 10: Levering</h1>
                        <p>Levering geschiedt ‘af fabriek/winkel/magazijn’. Dit houdt in dat alle kosten voor koper zijn.
                        ...
                        <br><br>
                        <h1>Artikel 11: Overmacht</h1>
                        <p>Kan verkoper niet, niet tijdig of niet behoorlijk aan zijn verplichtingen uit de overeenkomst voldoen door overmacht, dan is hij niet aansprakelijk voor door koper geleden schade.
                        ...
                        <br><br>
                        <h1>Artikel 12: Overdracht van rechten</h1>
                        <p>Rechten van een partij uit deze overeenkomst kunnen niet worden overgedragen zonder de voorafgaande schriftelijke instemming van de andere partij.
                        ...
                        <br><br>
                        <h1>Artikel 13: Eigendomsvoorbehoud en retentierecht</h1>
                        <p>De bij verkoper aanwezige zaken en geleverde zaken en onderdelen blijven eigendom van verkoper totdat koper de gehele afgesproken prijs heeft betaald. Tot die tijd kan verkoper zich beroepen op zijn eigendomsvoorbehoud en de zaken terugnemen.
                        ...
                        <br><br>
                        <h1>Artikel 14: Aansprakelijkheid </h1>
                        ...
                        <br><br>
                        <h1>Artikel 15: Klachtplicht</h1>
                        <p>Koper is verplicht klachten over de verrichte werkzaamheden direct te melden aan verkoper. De klacht bevat een zo gedetailleerd mogelijke omschrijving van de tekortkoming, zodat verkoper in staat is hierop adequaat te reageren.
                            Is een klacht gegrond, dan is verkoper gehouden het product eventueel te repareren of samen met de koper op een gezamelijke tegemoetkoming komen.
                        </p>
                        <br><br>
                        <h1>Artikel 16: Garanties</h1>
                        ...
                        <br><br>
                        <h1>Artikel 17: Toepasselijk recht en bevoegde rechter</h1>
                        <p>Op iedere overeenkomst tussen partijen is uitsluitend het Nederlands recht van toepassing.
                            De Nederlandse rechter in het arrondissement waar Multiversum is gevestigd/praktijk houdt/kantoor houdt is exclusief bevoegd om kennis te nemen van eventuele geschillen tussen partijen, tenzij de wet dwingend anders voorschrijft.
